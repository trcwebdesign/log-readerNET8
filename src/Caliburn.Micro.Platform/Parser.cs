...
#endif
{
    ...
    public static class Parser
    {
        ...
        public static IEnumerable<TriggerBase> Parse(System.Windows.DependencyObject target, string text)
        {
        ...
        public static Func<System.Windows.DependencyObject, string, Microsoft.Xaml.Behaviors.TriggerBase> CreateTrigger = (target, triggerText) =>
        {
            if (triggerText == null)
            {
        ...
        public static TriggerAction CreateMessage(System.Windows.DependencyObject target, string messageText)
        {
        ...
        /// </summary>
        public static Func<System.Windows.DependencyObject, string, TriggerAction> InterpretMessageText = (target, text) =>
        {
        ...
        /// </summary>
        public static Func<System.Windows.DependencyObject, string, Parameter> CreateParameter = (target, parameterText) =>
        {
            ...
            else if (target is System.Windows.FrameworkElement)
            {
                var fe = (System.Windows.FrameworkElement)target;
        ...
        public static void BindParameter(System.Windows.FrameworkElement target, Parameter parameter, string elementName, string path, BindingMode bindingMode)
        {
#if XFORMS
