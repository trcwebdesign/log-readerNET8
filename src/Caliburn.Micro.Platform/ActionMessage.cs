namespace Caliburn.Micro
{
    ...
    using EventTrigger = Microsoft.Xaml.Behaviors.EventTrigger; // Resolve ambiguity for EventTrigger
    using System.Windows.Controls.Primitives; // Add this using directive
    ...
    public class ActionMessage : TriggerAction<FrameworkElement>, IHaveParameters {
        ...
        static void HandlerPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            if (d is ActionMessage actionMessage) {
                actionMessage.UpdateContext();
            }
        }
